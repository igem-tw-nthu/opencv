...
def filter(image):
    ...
    positionX = [[74, 212, 370, 506, 742, 890, 1025, 1155],
                 [74, 217, 368, 508, 752, 896, 1034, 1172],
                 [76, 223, 366, 513, 753, 898, 1038, 1172],
                 [90, 223, 375, 519, 759, 902, 1044, 1177],
                 [97, 236, 379, 519, 768, 906, 1045, 1179],
                 [102, 241, 388, 528, 768, 909, 1045, 1174]]
    positionY = [[88, 82, 69, 69, 56, 63, 65, 74],
                 [224, 220, 212, 207, 210, 203, 210, 214],
                 [372, 365, 359, 359, 357, 350, 352, 352],
                 [517, 515, 508, 510, 503, 495, 495, 493],
                 [661, 655, 651, 651, 651, 644, 635, 627],
                 [806, 804, 802, 800, 791, 782, 767, 759]]
    square_length = 20
    for i in range(48):
        r = i % 8
        c = math.floor(i / 8)
